...
import com.ipsas.printmanagement.config.Constants;
import com.ipsas.printmanagement.domain.Employee;
import com.ipsas.printmanagement.domain.Teacher;
import com.ipsas.printmanagement.domain.User;
import com.ipsas.printmanagement.repository.UserRepository;
import com.ipsas.printmanagement.security.AuthoritiesConstants;
import com.ipsas.printmanagement.service.EmployeeService;
import com.ipsas.printmanagement.service.MailService;
import com.ipsas.printmanagement.service.TeacherService;
import com.ipsas.printmanagement.service.UserService;
import com.ipsas.printmanagement.service.dto.UserDTO;
import com.ipsas.printmanagement.web.rest.errors.BadRequestAlertException;
import com.ipsas.printmanagement.web.rest.errors.EmailAlreadyUsedException;
import com.ipsas.printmanagement.web.rest.errors.LoginAlreadyUsedException;
import com.ipsas.printmanagement.web.rest.util.HeaderUtil;
import com.ipsas.printmanagement.web.rest.util.PaginationUtil;
	...
	public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
		...
		for (String role : userDTO.getAuthorities()) {
			if (role.equals("ROLE_TEACHER")) {
				...
				teacher.setOrderedPrints(0);
				teacher.setUser(userRepository.findUserById(userDTO.getId()));
				teacherService.save(teacher);
				break;
			} else if (role.contentEquals("ROLE_EMPLOYEE")) {
				Employee employee = new Employee();
				employee.setPrintsNumber(0);
				employee.setUser(userRepository.findUserById(userDTO.getId()));
