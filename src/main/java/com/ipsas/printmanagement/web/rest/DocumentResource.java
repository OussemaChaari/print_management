...
public class DocumentResource {
    ...
    public ResponseEntity<Document> createDocument(@Valid @RequestBody Document document) throws URISyntaxException {
        ...
        String storeResult = documentService.storeFile(document);
        if (storeResult != null) {
            document.setFile(storeResult);
    ...
    public ResponseEntity<InputStreamResource> downloadPdf(@PathVariable Long id) {
        try {
            ...
            File file = new File("/home/lommja/Desktop/print_management/uploads/" + document.getFile()+".pdf");
