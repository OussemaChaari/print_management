...
public class TeacherResourceIntTest {
    ...
    private static final Integer DEFAULT_ORDERED_PRINTS = 1;
    private static final Integer UPDATED_ORDERED_PRINTS = 2;
    ...
    public static Teacher createEntity(EntityManager em) {
        Teacher teacher = new Teacher()
            .orderedPrints(DEFAULT_ORDERED_PRINTS);
        return teacher;
    }
    ...
    public void createTeacher() throws Exception {
        ...
        assertThat(testTeacher.getOrderedPrints()).isEqualTo(DEFAULT_ORDERED_PRINTS);
    }
    ...
    public void getAllTeachers() throws Exception {
        ...
        restTeacherMockMvc.perform(get("/api/teachers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].orderedPrints").value(hasItem(DEFAULT_ORDERED_PRINTS)));
    }
    ...
    public void getTeacher() throws Exception {
        ...
        restTeacherMockMvc.perform(get("/api/teachers/{id}", teacher.getId()))
            ...
            .andExpect(jsonPath("$.orderedPrints").value(DEFAULT_ORDERED_PRINTS));
    }
    ...
    public void updateTeacher() throws Exception {
        ...
        updatedTeacher
            .orderedPrints(UPDATED_ORDERED_PRINTS);
        ...
        Teacher testTeacher = teacherList.get(teacherList.size() - 1);
        assertThat(testTeacher.getOrderedPrints()).isEqualTo(UPDATED_ORDERED_PRINTS);
    }
