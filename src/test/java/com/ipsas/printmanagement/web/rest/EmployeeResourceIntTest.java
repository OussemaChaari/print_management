...
public class EmployeeResourceIntTest {
    ...
    private static final Integer DEFAULT_PRINTS_NUMBER = 1;
    private static final Integer UPDATED_PRINTS_NUMBER = 2;
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee()
            .printsNumber(DEFAULT_PRINTS_NUMBER);
        return employee;
    }
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getPrintsNumber()).isEqualTo(DEFAULT_PRINTS_NUMBER);
    }
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].printsNumber").value(hasItem(DEFAULT_PRINTS_NUMBER)));
    }
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.printsNumber").value(DEFAULT_PRINTS_NUMBER));
    }
    ...
    public void updateEmployee() throws Exception {
        ...
        updatedEmployee
            .printsNumber(UPDATED_PRINTS_NUMBER);
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getPrintsNumber()).isEqualTo(UPDATED_PRINTS_NUMBER);
    }
